...
const AuthForm = () => {
    ...
    return (
        <form className={style.form} onSubmit={handleSubmit}>
            <h2 className={style.title} >{type === 'login' ? 'Login' : 'Create your Free Account'}</h2>
                ...
                <div className={style.socialButtonContainer}>
                    ...
                    {type === 'signup' && (
                        <div className={style.signupTextContainer}>
                            <p className={style.signupText}>Already have an account? <button className={style.signupButton} type="button">Log in</button></p>
                        </div>
                    )}
